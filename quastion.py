...
import sys
import  re
from quastion2 import Ui_quastion2
from PyQt5 import QtCore
from PyQt5 import QtWidgets, QtGui
import user

class Ui_quastion(QtWidgets.QWidget):
    ...
    def s(self):
        ...
        self.ui = Ui_quastion2(None, self.current_user)
        self.ui.show()
    ...
    def setupUi(self):
        ...
        #start
        self.label.setText("<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">Вопрос: 1/10</span></p></body></html>")
