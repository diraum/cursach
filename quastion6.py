...
from quastion7 import Ui_quastion7

class Ui_quastion6(QtWidgets.QWidget):
    ...
    def s(self):
        ...
        self.ui = Ui_quastion7(None, self.current_user)
        self.ui.show()
    ...
    def setupUi(self):
        ...
        self.label.setText(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">Вопрос: 6/10</span></p></body></html>")
