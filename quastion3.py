...
from quastion4 import Ui_quastion4
import user


class Ui_quastion3(QtWidgets.QWidget):
    ...
    def s(self):
        ...
        self.close()
        self.ui = Ui_quastion4(None, self.current_user)
        self.ui.show()
    ...
    def setupUi(self):
        ...
        self.label.setText("<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; "
                           "color:#ffffff;\">Вопрос: 3/10</span></p></body></html>")
        self.label_2.setText("<html><head/><body><p><span style=\" font-size:11pt;\">Варианты ""ответов:</span></p"
                             "></body></html>")
