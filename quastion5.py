...
from quastion6 import Ui_quastion6
import  user

class Ui_quastion5(QtWidgets.QWidget):
    ...
    def s(self):
        ...
        self.close()
        self.ui = Ui_quastion6(None, self.current_user)
        self.ui.show()
    ...
    def setupUi(self):
        ...
        self.label.setText(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">Вопрос: 5/10</span></p></body></html>")
