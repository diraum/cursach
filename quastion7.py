...
from quastion8 import Ui_quastion8

class Ui_quastion7(QtWidgets.QWidget):
    ...
    def s(self):
        self.close()
        self.ui = Ui_quastion8(None, self.current_user)
        self.ui.show()
    ...
    def setupUi(self):
        ...
        self.label.setText(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">Вопрос: 7/10</span></p></body></html>")
