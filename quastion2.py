...
from quastion3 import Ui_quastion3
import user


class Ui_quastion2(QtWidgets.QWidget):
    ...
    def s(self):
        ...
        self.close()
        self.ui = Ui_quastion3(None, self.current_user)
        self.ui.show()
    ...
    def setupUi(self):
        ...
        self.label.setText("<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; "
                            "color:#ffffff;\">Вопрос: 2/10</span></p></body></html>")
        self.label_2.setText("<html><head/><body><p><span style=\" font-size:11pt;\">Варианты "
                             "ответов:</span></p></body></html>")

        self.pushButton.setText("следующий вопрос ->")
        self.label_3.setText("<html><head/><body><p><span style=\" font-size:9pt;\">примечание: вернуться на "
                             "предыдущий вопрос невозможно!</span></p></body></html>")
