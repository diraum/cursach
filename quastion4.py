...
from quastion5 import Ui_quastion5
import  user

class Ui_quastion4(QtWidgets.QWidget):
    ...
    def s(self):
        ...
        self.ui = Ui_quastion5(None, self.current_user)
    ...
    def setupUi(self):
        ...
        # start
        self.label.setText(
            "<html><head/><body><p align=\"center\"><span style=\" font-size:26pt; font-weight:600; color:#ffffff;\">Вопрос: 4/10</span></p></body></html>")
